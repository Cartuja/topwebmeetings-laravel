...
var THEMEREX_GLOBAL_ERROR_TEXT	= "Error";
var THEMEREX_NAME_EMPTY			= "El nombre no puede estar vacío";
var THEMEREX_NAME_LONG 			= "Nombre demasiado largo";
var THEMEREX_EMAIL_EMPTY 		= "Email demasiado corto (o vacío)";
var THEMEREX_EMAIL_LONG			= "Dirección de email demasiado larga";
var THEMEREX_EMAIL_NOT_VALID 	= "Dirección de email inválida";
var THEMEREX_MESSAGE_EMPTY 		= "El mensaje no puede estar vacío";
var THEMEREX_MESSAGE_LONG 		= "El mensaje es demasiado largo";
var THEMEREX_SEND_COMPLETE 		= "¡Mensaje enviado correctamente!";
var THEMEREX_SEND_ERROR 		= "¡Ocurrió un error durante el envío!";
var THEMEREX_LOGIN_EMPTY		= "El campo de usuario no puede estar vacío";
var THEMEREX_LOGIN_LONG			= "Nombre de usuario demasiado largo";
var THEMEREX_PASSWORD_EMPTY		= "La contraseña no puede estar vacía ni contener menos de 5 caracteres";
var THEMEREX_PASSWORD_LONG		= "Contraseña demasiado larga";
var THEMEREX_PASSWORD_NOT_EQUAL	= "La contraseña no coincide";
var THEMEREX_REGISTRATION_FAILED= "¡Registro fallido!";
var THEMEREX_REGISTRATION_AUTHOR= "¡Tu cuenta está pendiente de aprobación!";
var THEMEREX_GEOCODE_ERROR 		= "Falló la geolocalización por:";
var THEMEREX_GOOGLE_MAP_NOT_AVAIL="¡Mapas de Google no disponibles!";
var THEMEREX_NAVIGATE_TO		= "Ir a...";
var THEMEREX_ERROR_SESSION = "Debes iniciar sesion.";
...
var googleMaps = "España";
var reviews_max_level = 5;
var reviews_levels = "¡Muy mala!,Mala,Normalita,Buena,¡Muy buena!";
var reviews_vote = "";
...
jQuery(document).ready(function() {
	...
	jQuery('.link_login,.link_register,.popup_form .popup_title .popup_close').click(function(e) {
		...
		if (popup.length === 1) {
			...
			if (jQuery('.login_form').hasClass('icon-cancel')) {
				jQuery('.login_form').addClass('icon-login-1').removeClass('icon-cancel');
			} else {
	...
	jQuery('#popup_register .popup_button a').click(function(e){
		...
		/*if (!error) {
			jQuery.post("../ajax/registrarse.php", {
				...
				var rez = jQuery("#respuesta_registro").html(respuesta.html);
			});
		}*/
		e.preventDefault();
		return false;
	...
	if (jQuery('#nav_pages > ul > li').length < 0) {
