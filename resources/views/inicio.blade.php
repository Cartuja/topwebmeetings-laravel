  ...
  <?php } ?>
    ...
    <div class="post_content">
      ...
      <div class="title_area">
        <h2 class="post_title"><a href='web.php?id='class="theme_title">{{ $webs[$i]['NombreWeb'] }}</a></h2>
        <!-- estrellas -->
       ...
       <div class="post_text_area">
        <div class="sc_column_item sc_column_item_4">
          <ul class="sc_list sc_list_style_check">
            <li class="sc_list_item first"><span class="sc_list_icon">{{ $webs[$i]['Caracteristica1'] }}</span></li>
            <li class="sc_list_item"><span class="sc_list_icon">{{ $webs[$i]['Caracteristica2'] }}</span></li>
            <li class="sc_list_item sc_list_style_error"><span class="sc_list_icon">{{ $webs[$i]['Caracteristica3'] }}</span></li>
          </ul>
        </div>
