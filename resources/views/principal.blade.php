...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="images/favicon1.ico" />
	...
	<link href="{{ asset('/public/css/color.css') }}" rel="stylesheet" type="text/css" >
</head>
				...
				<div id="header_middle"  >
					<div id="header_middle_inner">
						...
						<ul id="mainmenu" class="sf-js-enabled">
							<li class="lightblue"><a href="<?php echo route ('inicio') ?>" class="sf-with-ul">Inicio<span class="sf-sub-indicator icon-right-open"></span></a></li>
							<li class="brown"><a href="<?php echo route ('web') ?>" class="sf-with-ul">Webs<span class="sf-sub-indicator icon-right-open"></span></a></li>
